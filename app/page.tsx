...
export default function Home() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Welcome to PythonPal: Your AI Python Tutor!</h1>
      <div className="prose max-w-none mb-8">
        ...
        <p>
          ...
          learners motivated. The AI tutor provides real-time feedback and adapts its teaching style to each
          child&apos;s pace and interests, ensuring a truly tailored learning experience.
        </p>
      </div>
